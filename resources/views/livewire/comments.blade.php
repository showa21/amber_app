<div class="flex justify-center">
    <div class="w-6/12">
        ...
        <div>
            <div class="my-4 flex">
                <input type="text" class="w-full rounded border shadow p-2 mr-2 my-2" placeholder="What is on your mind" wire:model="newComment">
                <div class="py-2">
            ...
            @foreach ($comments as $comment )
                <div class="rounded border shadow p-3 my-2">
                    <div class="flex justify-start mmy-2">
